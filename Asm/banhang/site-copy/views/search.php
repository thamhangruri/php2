<nav aria-label="breadcrumb"
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#" style="color: black">Tìm kiếm</a></li>
    </ol>
</nav>
    ...
    <div class="container bg-white pb-5">
        <div class="col-sm-12 p-0 bg-white">
            <div class="name-collection">
                <p>Tất cả sản phẩm - <?php echo $timkiem ?> </p>
            </div>
        </div>
        <div class="pt-2">
        ...
        <nav aria-label="Page navigation example" style="background-color: white;">
            <ul class="pagination bg-white justify-content-center" style="margin: 0 auto;">
                ...
                while ($i<=$total_page) {
                    echo '<li class="page-item"><a class="page-link" style="background-color: #463c3c;color: white;" href="?ctrl=search&act=search='.$keyword.'&current_page=' . $i . '">' . $i . '</a></li>
                    ';
                    $i++;
                }
                ?>
