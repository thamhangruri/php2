...
class home {
    ...
    function cart(){
        ...
        header("location:?ctrl=home&act=cartview");
    }//function cart
...
//        header("location:?ctrl=home&act=cartview");
    ...
    function cartview(){ //Hiển thị giỏ hàng
        if($_SESSION['infor']['count']==0){
            echo '<script>alert("Giỏ hàng chưa có sản phẩm nào! Vui lòng chọn sản phẩm !");window.location="?ctrl=home&act=allproducts"</script>';
        }else{
