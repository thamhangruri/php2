    ...
    <div class="container-fluid p-0 m-0">
        <header>
                    ...
                    <div class="justify-content-end" style="right: 10%;position: absolute;">
                        <?php
                            if(isset($_SESSION['user'])){
                               ...
                               echo' <a class="navbar-brand text-white " href="?ctrl=login"> Đăng Nhập</a>
                                    <a class="navbar-brand text-white " href="?ctrl=login&act=register"> Đăng Ký</a>';
                            }?>
                    </div>
                </div>
            </div>
            <nav class="navbar navbar-expand-lg text-uppercase nav-chinh" style="background-color: black">
                <div class="container">
                    <a class="nav-link" href="?ctrl=home"> Trang chủ </a>
                    <a class="nav-link" href="?ctrl=home&act=allproducts"> Điện thoại </a>
                    <a class="nav-link" href="?ctrl=home&act=cat"> Hãng </a>
                    <a class="nav-link" href="#"> Khuyến Mãi </a>
                    <a class="nav-link" href="#"> Tin tức </a>
                    <a class="nav-link" href="?ctrl=home&act=cartview"> <i class="fas fa-shopping-cart"
