                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped text-center">
                                            ...
                                            <?php $i=1;$totalprice=0; foreach ($_SESSION['giohang'] as $idProduct => $sp){
                                                ...
                                                <tr>
                                                    <td><?=$i?></td>
                                                    <td><img style="width: 50px" src="../site/Images/<?=$sp['urlHinh']?>"/></td>
                                                    <td><?=$sp['TenDT']?></td>
                                                    <td>
                                                        <div>
                                                            <div class="def-number-input number-input safari_only w-100">
                                                                ...
                                                                <input class="quantity text-center" id="number-order" data-id="<?php echo $sp['idDT']?>" min="0" max="<?php echo $sp['soluongtonkho']?>" name="quantity[<?php echo $sp['idDT'] ?>]" value="<?php echo $sp['Amount'] ?>" type="number" style="width: 60px;">
                                                                <a id="cong" onclick=" this.parentNode.querySelector('input[type=number]').stepUp();"
                                                    ...
                                                    <td id="sub_total-<?=$sp['idDT']?>" class="text-right "><?= number_format($sp['Gia']*$sp['Amount'])?></td>
                                                    <td class="text-right">
                                                        <a href="?ctrl=home&act=cart&what=remove&id=<?=$idProduct?>" class="btn btn-sm btn-danger" onclick="return ConfirmDelete()"><i class="fa fa-trash"></i>
                                                        </a>
                                                    </td>
                                                </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td>Tổng Tiền </td>
                                                <td id="total-price"" class="text-right"><?php echo number_format($_SESSION['infor']['total']) ?> VNĐ</td>
                                            </tr>
                                            </tbody>
                                        </table>
                                    </div>
