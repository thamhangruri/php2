...
<div class="show-product p-0">
    <div class="container bg-white">
        <div class="row mt-4 pt-3"> <!-- Hiển thị thông tin -->
            <div class="col-sm-4">
                <img src="Images/<?= $sp['urlHinh'] ?>" class="zoom" alt="NC01221" width="100%">
            </div>
            <div class="col-sm-8 text-collection">
                ...
                <div class="row text-uppercase">
                    <div class="col-sm-3">
                        <a href="?ctrl=home&act=cart&what=add&id=<?= $sp['idDT'] ?>" class="btn">Thêm vào giỏ hàng</a>
                    </div>
                    <div class="col-sm-3">
            ...
            <form action="index.php?ctrl=home&act=comment&idsp=<?php echo $_GET['id'] ?>&uid=<?php echo $_SESSION['user']['uid'] ?>"
                ...
                if (isset($_SESSION['user'])) {
                    echo '<h5 style="text-align: center;"> Gửi Bình Luận </h5>
                        <div class="row">
                            <div class="col-sm-1"><img src="Images/'.$_SESSION['user']['hinh'].'" width="80px"> </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                foreach ($comment as $cmt) {
                    ...
                    $cmtt=date('d/m/Y - H:i:s',strtotime($cmt['ThoiDiemBL']));
                    $role = '';
                    if ($cmt['vaiTro'] == 0) {
                        $role = 'Khách hàng';
